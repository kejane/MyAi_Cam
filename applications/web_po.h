 ...
 */
#ifndef APPLICATIONS_WEB_PO_H_
#define APPLICATIONS_WEB_PO_H_
...
#define POST_HEADER_BUFSZ   21302
#define _MEM_LENGTH 79000
#elif defined _POST_JPG_
#define POST_RESP_BUFSZ     1024
#define POST_HEADER_BUFSZ   8192
#define _MEM_LENGTH 10240
#endif

#ifdef _USE_BEMFA_
#define POST_LOCAL_URI                "http://images.bemfa.com/upload/v1/upimages.php"
#define _content_type                 "Content-Type: image/jpg\r\n"
#define _authorization                "Authorization: 1f847d8a416351dfe374e8c86460c56c\r\n"
#define _topic                        "Authtopic: pic\r\n"
#elif defined _USE_ONENET_
#define GET_HEADER_BUFSZ               2048
#define GET_RESP_BUFSZ                 1024
#define POST_LOCAL_URI                "http://api.heclouds.com/bindata?device_id=787994914&datastream_id=person_dectation"
#define POST_ANOTHER_URI              "http://api.heclouds.com/bindata?device_id=787994914&datastream_id=photo"
#define GET_LOCAL_URI                 "http://api.heclouds.com/devices/787994914/datastreams/button"
#define _content_type                 "Content-Type: image/jpg\r\n"
#define _api_key                      "api-key: nfm1Hrzybqre5qCJiTPe=z=4UJw=\r\n"
#endif


int _mem_to_malloc_ = _MEM_LENGTH;

char bmp_header_[1078] = {
    0x42, 0x4D, 0x36, 0x30, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x36, 0x04, 0x00, 0x00, 0x28, 0x00,
    0x00, 0x00, 0x40, 0x01, 0x00, 0x00, 0xF0, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08, 0x00, 0x00, 0x00,
...
//使用方法:传入图片二维数组,若是检测到有人上传,mode参数写0,若是遥控拍照上传,mode参数写1
extern int web_post_pic(rt_uint8_t draw_data_src[][320], int mode);

/******/
extern int web_get_command(void);
/******/

#endif /* APPLICATIONS_WEB_PO_H_ */
