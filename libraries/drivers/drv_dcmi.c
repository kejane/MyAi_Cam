...
static void rt_hw_dcmi_dma_init(void)
{
    ...
    hdma_dcmi.Instance                 = DMA2_Stream1;//通道
    hdma_dcmi.Init.Request             = DMA_REQUEST_DCMI;
    hdma_dcmi.Init.Direction           = DMA_PERIPH_TO_MEMORY;//外设地址
    hdma_dcmi.Init.PeriphInc           = DMA_PINC_DISABLE;
    hdma_dcmi.Init.MemInc              = DMA_MINC_ENABLE;//数据地址自增使能
    ...
    HAL_NVIC_EnableIRQ(DMA2_Stream1_IRQn);//DMA中断
    HAL_NVIC_SetPriority(DCMI_IRQn, 0, 0);//帧中断
