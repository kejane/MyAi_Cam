...
#ifndef __AI_IFPERSON_H__
#define __AI_IFPERSON_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_IFPERSON_MODEL_NAME          "ifperson"

#define AI_IFPERSON_ACTIVATIONS_ALIGNMENT   (4)

#define AI_IFPERSON_IN_NUM       (1)
#define AI_IFPERSON_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 50, 50, 1, 1, NULL), \
}
#define AI_IFPERSON_IN_SIZE { \
  (50 * 50 * 1), \
}
#define AI_IFPERSON_IN_1_SIZE  (50 * 50 * 1)
#define AI_IFPERSON_IN_1_SIZE_BYTES  ((50 * 50 * 1) * 1)





#define AI_IFPERSON_OUT_NUM      (1)
#define AI_IFPERSON_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 1, 1, NULL), \
}
#define AI_IFPERSON_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_IFPERSON_OUT_1_SIZE  (1 * 1 * 1)
#define AI_IFPERSON_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 1)

#define AI_IFPERSON_N_NODES (9)
 ...
 * @ref ai_ifperson_create. Both the activations memory buffer 
 ...
 * using @ref ai_ifperson_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_IFPERSON_*
 * defines into file @ref ifperson.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_ifperson_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_IFPERSON_H__*/
